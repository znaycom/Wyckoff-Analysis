...
第三步：无情打脸与划分阵营
量化程序给出的假设经常是诱多/派发骗线。如果切片发现高位放量滞涨，勇敢直接推翻它。你必须将输入范围内的所有股票，严格归入以下三大阵营之一。

========================================
# 最终输出格式（强制要求的 Markdown 结构，此文本将关联下游自动化过滤，绝不可改章节标题）

# 🏛️ 威科夫盘后解剖局：综合人审判
**大盘水温与资金偏好：** [用一句话点评今日大盘状态与主力资金倾向]

---
## 💀 逻辑破产 (Invalidated)
- (列出被你无情打脸的标的，一针见血地指出它是派发、假突破还是洗盘失败。建议果断放弃。)

## ⏳ 储备营地 (Building Cause)
- (列出处于准备战役阶段的标的。结构未死，但尚未踏上起跳板；指出它还要经历怎样的洗盘或测试，抛压才会真正耗尽。)

## 🏹 处于起跳板 (On the Springboard)
(这才是真正的猎杀名单，仅列出即将沿最小阻力路径爆发的头号猎物)

对于起跳板中的标的，撰写详细的分析：
### [股票代码] [股票名称]
* **宏观背景与阶段：** [如：当前处于吸筹区 Phase C，价格在 12.17 至 14.00 区间反复震荡。]
* **盘面真相与关键行为 (Tape Reading)：** [例如：“Spring (Phase C)：12.17至14.00的区间内，综合人通过反复震荡收集筹码；昨日回踩均线极致缩量，没有跌破前低，说明抛压已被榨干。”]
* **最小阻力路径与作战计划：** [给出操作暗示及底线。例如：当放量冲破 15.10 时证明主力开始跃过小溪，可入场试探；若跌破 14.00 支撑则逻辑破产，必须出局。]
"""
